  ...
  <section class="featured-books">
    <div class="container">
      <div class="header">
        ...
        <p>Best rated by our customers</p>
      </div>
      <div class="book-list">
        <div
          class="book"
          v-for="book in books"
          :key="book.id"
          @mouseover="hover = book.id"
          @mouseleave="hover = null"
        >
          <div class="image-container">
            <img :src="book.image" :alt="book.title" />
            <transition name="fade">
              <div v-if="hover === book.id" class="overlay">
      ...
      books: [
        {
          ...
          category: "Kiến trúc, Lối sống",
          title: "Interior design is more than a hobby",
          author: "Janet",
          price: "$15.00",
        },
        {
          ...
          category: "Nghệ thuật & Nhiếp ảnh, Lối sống",
          title: "A beautiful image is a perfect moment frozen",
          author: "Henry",
          price: "$32.00",
        },
        {
