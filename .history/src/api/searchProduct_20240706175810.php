...
if (isset($_GET['keyword'])) {
    ...
    $sql = "SELECT DISTINCT s.maSach AS MaSach, s.chiTiet AS ChiTiet, nxbs.tenNXB AS NhaXuatBan,
    s.tenSach AS TenSach, s.hinhAnh AS HinhAnh, s.donGia AS DonGia, tg.tenTG AS TacGia, tg.maTG AS MaTacGia, 
    nn.maNN AS MaNgonNgu, nn.tenNN AS NgonNgu,DISTINCT dm.tenDM AS DanhMuc, km.luongKM AS KhuyenMai
   FROM sach AS s
   ...
   ";
    ...
    echo json_encode("Không có từ khóa được cung cấp");
}
?>