...
// Truy vấn danh sách đơn hàng của tất cả người dùng
$sql_get_orders = "
    SELECT ddh.maDon AS MaDon, s.maSach AS MaSach, s.tenSach AS TenSach, s.hinhAnh AS HinhAnh, 
           ...
           nd.diachi AS DiaChi, nd.email as Email, nd.tenKH as TenKH, nd.sdt as SoDienThoai,nd.taikhoan as Taikhoan,
