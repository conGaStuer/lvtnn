...
if ($filterType == 'day' && $filterValue) {
    $sql_orders .= " WHERE ngaydat = '$filterValue' and trangthai = 'giaohangthanhcong'";
...
$sql_revenue = "SELECT SUM(chi_tiet_don_hang.dongia * chi_tiet_don_hang.soluong) as total_revenue FROM chi_tiet_don_hang ctdh
join don_dat_hang ddh on ctdh.madon = ddh.madon WHERE ddh.ngaydat = '$filterValue'
";
