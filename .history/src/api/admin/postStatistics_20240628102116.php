...
$sql_orders = "SELECT COUNT(*) as total_orders FROM don_dat_hang WHERE 1=1"; // Always true condition

if ($filterType == 'day' && $filterValue) {
    $sql_orders .= " AND ngaydat = '$filterValue' AND trangthai = 'giaohangthanhcong'";
    ...
    $sql_orders .= " AND ngaydat BETWEEN '$startOfWeek' AND '$endOfWeek' AND trangthai = 'giaohangthanhcong'";
    ...
    $sql_orders .= " AND ngaydat BETWEEN '$startOfMonth' AND '$endOfMonth' AND trangthai = 'giaohangthanhcong'";
}
