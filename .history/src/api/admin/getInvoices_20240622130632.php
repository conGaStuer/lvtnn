...
$sql_get_invoices = "
    SELECT ddh.maDon AS MaDon, GROUP_CONCAT(s.maSach) AS MaSach, GROUP_CONCAT(s.tenSach) AS TenSach, 
           GROUP_CONCAT(s.hinhAnh) AS HinhAnh, SUM(ctdh.SoLuong) AS SoLuong, SUM(ctdh.DonGia) AS TongTien,
           ddh.ngayDat AS NgayDat, ddh.maND AS MaND, u.tenNguoiDung AS TenNguoiDung, u.sdt AS SDT,
