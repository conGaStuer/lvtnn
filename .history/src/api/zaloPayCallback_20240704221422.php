...
file_put_contents('debug_log.txt', print_r($data, true) . PHP_EOL, FILE_APPEND);
...
// Debugging: log the MAC comparison
file_put_contents('debug_log.txt', "Received MAC: $received_mac, Calculated MAC: $calculated_mac" . PHP_EOL, FILE_APPEND);
...
file_put_contents('debug_log.txt', print_r($payload, true) . PHP_EOL, FILE_APPEND);
