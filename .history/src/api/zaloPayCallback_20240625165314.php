...
$sql_update_order = "UPDATE don_dat_hang SET trangthai = 'choduyet' WHERE madon = '$appTransId'";
if ($conn->query($sql_update_order) === TRUE) {
    // Insert order event
    $sql_add_event = "INSERT INTO order_events (order_id, event, timestamp) VALUES ('$appTransId', 'choduyet', NOW())";
