...
try {
    ...
    error_log('Received data: ' . $postdata); // Log received data for debugging
    ...
    error_log('Decoded JSON: ' . print_r($postdatajson, true)); // Log decoded JSON for debugging
    ...
    if ($datajson === null) {
        throw new Exception("Failed to decode inner JSON data");
    }
    error_log('Inner decoded JSON: ' . print_r($datajson, true)); // Log inner decoded JSON for debugging
