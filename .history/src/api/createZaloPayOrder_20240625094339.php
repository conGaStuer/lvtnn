...
if ($result['return_code'] == 1) {
    // Thành công, gọi callback tới zaloCallback.php
    $callback_data = [
    ...
    $callback_response = file_get_contents('http://localhost/LVTN/book-store/src/api/zaloPayCallback.php', false, $callback_context);
