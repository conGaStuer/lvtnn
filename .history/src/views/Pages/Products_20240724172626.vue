      ...
      <div class="header">
        ...
        <div class="filter">
          ...
          <select v-model="sortBy">
            ...
            <option value="priceAscDiscount">KM : Từ thấp đến cao</option>
            <option value="priceDescDiscount">KM : Từ cao đến thấp</option>
          </select>
        </div>
      </div>
...
export default {
  ...
  setup() {
    ...
    const sortedBooks = computed(() => {
      ...
      if (sortBy.value === "priceAscDiscount") {
        sorted.sort((a, b) => {
          return a.TenSach.length - b.TenSach.length;
        });
      } else if (sortBy.value === "priceDescDiscount") {
        sorted.sort((a, b) => {
          return b.KhuyenMai - a.KhuyenMai;
        });
      }
      return sorted;
    });
