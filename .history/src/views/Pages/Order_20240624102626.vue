  ...
  return [
    {
      ...
      DonGia: parseFloat(order.GiaDonHang),
      SoLuong: parseInt(order.SoLuong),
      TacGia: order.TacGia.split(",")[0].trim(), // Lấy tác giả đầu tiên
      NgonNgu: order.NgonNgu.split(",")[0].trim(), // Lấy ngôn ngữ đầu tiên
      DanhMuc: order.DanhMuc.split(",")[0].trim(), // Lấy danh mục đầu tiên
      KhuyenMai: parseFloat(order.KhuyenMai),
    },
  ];
};
