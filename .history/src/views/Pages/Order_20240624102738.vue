...
const parseOrderItems = (order) => {
  ...
  const tacGiaArray = order.TacGia ? order.TacGia.split(",") : []; // Ensure TacGia is converted to array
  ...
  return maSachArray.map((maSach, index) => {
    return {
      ...
      TacGia: tacGiaArray[index] || "", // Ensure TacGia is initialized as empty string if undefined
