...
const parseOrderItems = (order) => {
  ...
  const tacGiaArray =
    typeof order.TacGia === "string" ? order.TacGia.split(",") : [];
  const ngonNguArray =
    typeof order.NgonNgu === "string" ? order.NgonNgu.split(",") : [];
  const danhMucArray =
    typeof order.DanhMuc === "string" ? order.DanhMuc.split(",") : [];

  const khuyenMaiArray =     typeof order.KhuyenMai === "string" ? order.KhuyenMai.split(",") : [];
