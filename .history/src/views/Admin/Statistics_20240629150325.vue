<template>
  <div class="statistics">
    ...
    <template v-else-if="filterType === 'week'">
      <a-week-picker v-model:value="selectedWeek" @change="logWeek" />
    </template>
    <template v-else-if="filterType === 'month'">
      <a-month-picker v-model:value="selectedMonth" @change="logMonth" />
    </template>
    <template v-else-if="filterType === 'year'">
      <a-year-picker v-model:value="selectedYear" @change="logYear" />
    </template>
