  ...
  <div class="dashboard">
    <div class="card flex justify-content-center">
      ...
      <div class="chart-label">
        <p>
          {{ pieChartData.value.labels[0] }}:
          {{ pieChartData.value.datasets[0].data[0] }}
        </p>
        <p>
          {{ pieChartData.value.labels[1] }}:
          {{ pieChartData.value.datasets[0].data[1] }}
        </p>
        <p>
          {{ pieChartData.value.labels[2] }}:
          {{ pieChartData.value.datasets[0].data[2] }}
        </p>
      </div>
    </div>
    <div class="card flex justify-content-center">
      ...
      <div class="chart-label">
        <p>
          {{ barChartData.value.labels[0] }}:
          {{ barChartData.value.datasets[0].data[0] }}
        </p>
        <p>
          {{ barChartData.value.labels[1] }}:
          {{ barChartData.value.datasets[0].data[1] }}
        </p>
        <p>
          {{ barChartData.value.labels[2] }}:
          {{ barChartData.value.datasets[0].data[2] }}
        </p>
      </div>
    </div>
